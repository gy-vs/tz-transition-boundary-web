...
const rows: RecordRow[] = [
  {id:'alpha',name:'Primary timezone bundles',revision:3,content:'timezone bundles: alpha\nstate: active',updatedAt:new Date(0).toISOString()},
  {id:'beta',name:'Secondary timezone bundles',revision:5,content:'timezone bundles: beta\nstate: review',updatedAt:new Date(1000).toISOString()},
];
